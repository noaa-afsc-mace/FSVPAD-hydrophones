...
sys.path.append(r'C:\Users\MACE\Desktop\serialLogging')
...
from ui_GPS_RangeBearing import Ui_MainWindow
...
class Drifter(QMainWindow, Ui_MainWindow):
        ...
        def GPSsetup(self):
                ...
                dirname = r"C:\Users\MACE\Documents\DrifterData\GPS_Files_YMD_"
                ...
                # set up serial connections based configuration file
                parser = SafeConfigParser()
                parser.read(r"C:\Users\MACE\Documents\DrifterData\GUI_Configuration.txt")
        ...
        def StartLogging(self):
                ...
                #  there was a problem with the serial port
                        print('Serial port error:' + e.errText)
        ...
        #  if you're logging to different files, you can branch based on the device     
        ...
        def endGPScalc(self):  
                ...
                self.statusbox.setText('INACTIVE')
                self.rangebox.setText('CLOSING GUI...')
                time.sleep(10)
                self.fn_drift.close()
                self.fn_ship.close()
                sys.exit(app.exec_())
